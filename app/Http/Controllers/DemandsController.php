...
class DemandsController extends Controller
{
    public function index()   {
        ...
        return Inertia::render('Admin/Demands/Index', compact('demands'));
    }
    public function trash(){
        $demands =Demand::onlyTrashed()->get();
        return Inertia::render('Admin/Demands/Trash', compact('demands'));
    }
    public function show(Demand $demand){
        $demand = $this->refactorDemand($demand);
        return Inertia::render('Admin/Demands/Show', compact('demand'));
    }
